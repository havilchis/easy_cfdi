...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:cfdi="http://www.sat.gob.mx/cfd/3" xmlns:cce11="http://www.sat.gob.mx/ComercioExterior11" xmlns:donat="http://www.sat.gob.mx/donat" xmlns:divisas="http://www.sat.gob.mx/divisas" xmlns:implocal="http://www.sat.gob.mx/implocal" xmlns:leyendasFisc="http://www.sat.gob.mx/leyendasFiscales" xmlns:pfic="http://www.sat.gob.mx/pfic" xmlns:tpe="http://www.sat.gob.mx/TuristaPasajeroExtranjero" xmlns:nomina12="http://www.sat.gob.mx/nomina12" xmlns:registrofiscal="http://www.sat.gob.mx/registrofiscal" xmlns:pagoenespecie="http://www.sat.gob.mx/pagoenespecie" xmlns:aerolineas="http://www.sat.gob.mx/aerolineas" xmlns:valesdedespensa="http://www.sat.gob.mx/valesdedespensa" xmlns:consumodecombustibles="http://www.sat.gob.mx/consumodecombustibles" xmlns:notariospublicos="http://www.sat.gob.mx/notariospublicos" xmlns:vehiculousado="http://www.sat.gob.mx/vehiculousado" xmlns:servicioparcial="http://www.sat.gob.mx/servicioparcialconstruccion" xmlns:decreto="http://www.sat.gob.mx/renovacionysustitucionvehiculos" xmlns:destruccion="http://www.sat.gob.mx/certificadodestruccion" xmlns:obrasarte="http://www.sat.gob.mx/arteantiguedades" xmlns:ine="http://www.sat.gob.mx/ine" xmlns:iedu="http://www.sat.gob.mx/iedu" xmlns:ventavehiculos="http://www.sat.gob.mx/ventavehiculos" xmlns:terceros="http://www.sat.gob.mx/terceros" xmlns:pago10="http://www.sat.gob.mx/Pagos" xmlns:detallista="http://www.sat.gob.mx/detallista" version="2.0">
  ...
  <!--
	...
	-->
  <xsl:include href="./vendor/plantillas_sat/utilerias.xslt.rb"/>
  <!--
		En esta sección se define la inclusión de las demás plantillas de transformación para
		la generación de las cadenas originales de los complementos fiscales
	-->
  <xsl:include href="./vendor/plantillas_sat/ecc11.xslt.rb"/>
  <xsl:include href="./vendor/plantillas_sat/donat11.xslt.rb"/>
  <xsl:include href="./vendor/plantillas_sat/divisas.xslt.rb"/>
  <xsl:include href="./vendor/plantillas_sat/implocal.xslt.rb"/>
  <xsl:include href="./vendor/plantillas_sat/leyendasFisc.xslt.rb"/>
  <xsl:include href="./vendor/plantillas_sat/pfic.xslt.rb"/>
  <xsl:include href="./vendor/plantillas_sat/TuristaPasajeroExtranjero.xslt.rb"/>
  <xsl:include href="./vendor/plantillas_sat/nomina12.xslt.rb"/>
  <xsl:include href="./vendor/plantillas_sat/cfdiregistrofiscal.xslt.rb"/>
  <xsl:include href="./vendor/plantillas_sat/pagoenespecie.xslt.rb"/>
  <xsl:include href="./vendor/plantillas_sat/aerolineas.xslt.rb"/>
  <xsl:include href="./vendor/plantillas_sat/valesdedespensa.xslt.rb"/>
  <xsl:include href="./vendor/plantillas_sat/consumodecombustibles.xslt.rb"/>
  <xsl:include href="./vendor/plantillas_sat/notariospublicos.xslt.rb"/>
  <xsl:include href="./vendor/plantillas_sat/vehiculousado.xslt.rb"/>
  <xsl:include href="./vendor/plantillas_sat/servicioparcialconstruccion.xslt.rb"/>
  <xsl:include href="./vendor/plantillas_sat/renovacionysustitucionvehiculos.xslt.rb"/>
  <xsl:include href="./vendor/plantillas_sat/certificadodedestruccion.xslt.rb"/>
  <xsl:include href="./vendor/plantillas_sat/obrasarteantiguedades.xslt.rb"/>
  <xsl:include href="./vendor/plantillas_sat/ComercioExterior11.xslt.rb"/>
  <xsl:include href="./vendor/plantillas_sat/ine11.xslt.rb"/>
  <xsl:include href="./vendor/plantillas_sat/iedu.xslt.rb"/>
  <xsl:include href="./vendor/plantillas_sat/ventavehiculos11.xslt.rb"/>
  <xsl:include href="./vendor/plantillas_sat/terceros11.xslt.rb"/>
  <xsl:include href="./vendor/plantillas_sat/Pagos10.xslt.rb"/>
  <xsl:include href="./vendor/plantillas_sat/detallista.xslt.rb"/>
